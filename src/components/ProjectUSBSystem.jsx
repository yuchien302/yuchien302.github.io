...
var ProjectUSBSystem = React.createClass({
  ...
  render: function() {
    return (
      ...
      <div style={this.props.style}  className="item" key={1}>
        <Card>
          <CardTitle title="USBAlarmSystem" subtitle="Monitoring unauthorized flash drive usage"/>
          <CardMedia>
            <img src="/dist/images/usbsystem.jpg"/>
          </CardMedia>
